...
这是我在学习 Vue3 中基于[Element-plus](https://element-plus.org/zh-CN/) 二次封装基础组件文档，希望对你有用。可查看 [详细组件案例文档](https://wocwin.github.io/zc-test/) 预览
...
<head>
  <!-- Import style -->
  <link rel="stylesheet" href="//unpkg.com/zc-test/lib/style.css" />
  <!-- Import Vue 3 -->
  <script src="//unpkg.com/vue@3"></script>
  <!-- Import component library -->
  <script src="https://unpkg.com/zc-test@latest"></script>
</head>
```
## zc-test Volar 组件类型提示
